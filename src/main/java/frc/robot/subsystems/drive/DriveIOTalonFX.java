...
public class DriveIOTalonFX implements DriveIO {
    ...
    private final StatusSignal<Double> rightFollowerCurrent =
            driveMotorBackRight.getStatorCurrent();
    ...
    public void updateInputs(DriveIOInputs inputs) {
        ...
        inputs.leftCurrentAmps =
                new double[] {
                    leftLeaderCurrent.getValueAsDouble(), leftFollowerCurrent.getValueAsDouble()
                };
